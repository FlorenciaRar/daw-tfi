...
export class Respuesta{
    ...
    @OneToMany(() => RespuestaAbierta, (respuestaAbierta: RespuestaAbierta) => respuestaAbierta.respuesta, {
        cascade: ['insert'],
      })
    respuestasAbiertas: RespuestaAbierta[];

    @OneToMany(() => RespuestaOpcion, (respuestaOpcion: RespuestaOpcion) => respuestaOpcion.respuesta, {
        cascade: ['insert'],
      })
